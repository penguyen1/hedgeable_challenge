...
var ChartTest = React.createClass({
  ...
  componentWillMount(){
    ...
    // console.log('startDate: ', this.props.details[0].date)
    // console.log('lastDate: ', this.props.details[this.props.details.length-1].date)
    // this.setState({ 
    //   startDate: this.props.details[0].date,
    //   lastDate: this.props.details[this.props.details.length-1].date,
    //   startYear: +(this.props.details[0].date.split('-')[0]),
    //   lastYear: +(this.props.details[this.props.details.length-1].date.split('-')[0])
    // });
...
module.exports = ChartTest;
        ...
        //   }}
        //   yAccessor={(d)=> d.value }
        //   xAccessor={(d)=>{ return new Date(d.date) }}
        //   gridHorizontal={true} />